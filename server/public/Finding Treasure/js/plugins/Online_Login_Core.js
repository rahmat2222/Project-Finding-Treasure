 ...
 */
 ...
 Nasty.Parameters = $plugins.filter(function(p)
	...
	MMO_Scene_Title.prototype.usernamenya = "";

	MMO_Scene_Title.prototype.connectAttempt = function(){
		var that = this;
		var username = $("#inputUsername").val();
		var password = $("#inputPassword").val();
		MMO_Scene_Title.prototype.usernamenya = username;
		console.log(MMO_Scene_Title.prototype.usernamenya + "tessss");
        ...
        $.post($gameNetwork._serverURL+'/login', {
            ...
            that.fadeOutAll();
			if(data.simpan) {
				DataManager.loadSaveFromServer(data.simpan);
			}
	...
	MMO_Scene_Title.prototype.simpansave = function() {
		console.log(MMO_Scene_Title.prototype.usernamenya + "tessss");
		$gameSystem.onBeforeSave();
		var simpan = DataManager.ambilsave();
		var username = this.usernamenya;
		$.post($gameNetwork._serverURL+'/simpan', {
					username: username,
					simpan: simpan
		}).done(function (data) {
...
MMO_Scene_Title.prototype.simpansave();
	...
	MMO_Scene_Title.prototype.registerAttempt = function(){
		...
		if (data.msg) {
			...
			that.displayInfo("Berhasil, silahkan login");
		}
	});
	};
